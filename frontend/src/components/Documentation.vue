    ...
    <div class="container is-fullhd">
      ...
      <div class="columns is-variable is-8">
        ...
        <div id="documentation" class="column content has-text-justified">
          ...
          <p>Below the <i>External databases</i> table comes the <i>Reactions</i> table. It lists all reactions involving the current metabolite as a reactant or product. The current metabolite is highlighted in black in the reaction equations. Since metabolites are specific to a cell compartment, only reactions involving the metabolite in its specific compartment are displayed. To remove this restriction and display additional reactions involving the metabolite in any compartment, click the button <img src="/img/button-reaction-for-all-compartments.png" width="250" style="vertical-align:middle">. Note that the number of retrieved reactions is limited to 200. In order to retrieve all reactions users are recommended to use the <a href="#API">API</a>.</p>
