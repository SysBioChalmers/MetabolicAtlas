    ...
    <div class="container is-fullhd">
      ...
      <div class="columns is-variable is-8">
        ...
        <div id="documentation" class="column content has-text-justified">
          ...
          <p>Five buttons on the top left of the UI allow users to zoom in, zoom out, show/hide genes, show/hide subsystems, toggle fullscreen (exit the fullscreen mode with the key "Esc"), and download the SVG map on the current view.</p>
          ...
          <p>The SVGs are interactive; click on a node (metabolite, reaction, gene) or a subsystem to load some of its information in the sidebar. Additonal information on the corresponding selected element can be accessed by clicking the button <img src="/img/button-gem-browser.png" width="120" style="vertical-align:middle"> under the selected element on the left sidebar.</p>
