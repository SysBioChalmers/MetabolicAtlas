    ...
    <div class="container is-fullhd">
      ...
      <div class="columns is-variable is-8">
        ...
        <div id="documentation" class="column content has-text-justified">
          ...
          <p>Users can search for a specific item with id, name or alias by using the search bar on top of the 3D graph. The view will be zoomed in and centered on one of the found components. In case there are more than one found components, users can change the view to each found component by clicking the buttons <span><i class="fa fa-arrow-left"></i></span> <span><i class="fa fa-arrow-right"></i></span>   Click the 'highlight' button to color all found components on the maps in red. To remove the highlight, simply clear the search bar.</p>
