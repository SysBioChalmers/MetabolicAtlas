    ...
    return {
      menu: [
        ...
        { title: messages.gemBrowserName,
          ...
          route: { name: 'browserRoot', params: { model: 'Human-GEM' } },
          icon: 'table' },
        { title: messages.mapViewerName,
          ...
          route: { name: 'viewer', params: { model: 'Human-GEM', type: 'compartment', map_id: 'golgi_apparatus' }, query: { dim: '2d' } },
          icon: 'map-o' },
        { title: messages.interPartName,
          ...
          route: { name: 'interPartner', params: { model: 'Human-GEM', id: 'm02007p' } },
          icon: 'connectdevelop' },
        { title: 'Search',
