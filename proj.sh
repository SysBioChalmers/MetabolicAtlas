...
function generate-data {
  ...
  source frontend/.env && yarn --cwd $DATA_GENERATOR_PATH start $DATA_FILES_PATH "$@" && cp -r $DATA_GENERATOR_PATH/data/ ./neo4j/import
  cp -r $DATA_FILES_PATH/ftp-models ftp/ftp-models
}
